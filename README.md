...
/*PROGRAM TO RAILWAY E-TICKET BOOKING CANCELLATION PORTAL
AUTHOR:JAY PRAKASH
STATUS:RUNNING*/
#include<stdio.h>
#include<string.h>
...
scanf("%d",&st[t].tins);
if(st[t].c==1||st[t].c==2||st[t].c==3||st[t].c==4||st[t].c==5 &&
st[t].s==1||st[t].s==2||st[t].s==3||st[t].s==4||st[t].s==5||st[t].s==6)
{
switch(st[t].c)
{
case 1:
...
printf("\n\t**********************************************************************************************************");
printf("\n\t\t                             ************************************** ");
printf("\n\t************************* WELCOME TO RAILWAY TICKET BOOKING PORTAL *************************");
printf("\n\t\t                             ************************************** ");
printf("\n\t********************************************************************************************************\n\n");
for(i>0; ;i++)
{ system("color f4");
